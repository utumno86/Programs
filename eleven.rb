...
(0..19).each do |i|
  (0..19).each do |j|
    if j + 3 <= 19
      horizontal_right = grid[i][j] * grid[i][j + 1] * grid[i][j + 2] * grid[i][j + 3]
    ...
    if i + 3 <= 19
      vertical_up = grid[i][j] * grid[i + 1][j] * grid[i + 2][j] * grid[i + 3][j]
    ...
    if i + 3 <= 19 && j + 3 <= 19
      diagonal_left = grid[i][j] * grid[i + 1][j + 1] * grid[i + 2][j + 2] * grid[i + 3][j + 3]
      if high_num < diagonal_left
